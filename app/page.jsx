                    ...
                    <div className="swiper">
                      ...
                      <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide">
                            <div className="swiper-inner" data-bgimage="url(images/background/3.webp)">
                                <div className="sw-caption">
                                    <div className="container relative z-2" data-0="opacity:1" data-300="opacity:0">
                                            ...
                                            <div className="col-lg-6">
                                                <div className="relative z-2">
                                                    ...
                                                    <h1 className="mb-3 cam-style">
                                                        Crystal Clear View, Night Vision, Smart Motion
                                                        <span></span><span></span><span></span><span></span></h1>
                                                    <Link className="btn-main btn-line fx-slide mb10 mb-3" href="contact.html"><span>Learn More</span></Link>&nbsp;&nbsp;
                                                    <Link className="btn-main fx-slide mb10 mb-3" href="contact.html"><span>Buy Now</span></Link>
                                                </div>
                                            </div>
                                ...
                                <div className="sw-caption">
                                    <div className="container relative z-2" data-0="opacity:1" data-300="opacity:0">
                                        <div className="row align-items-center g-4">
                                            <div className="col-lg-6">
                                                <div className="relative z-2">
                                                    <h3 className="subtitle s2 mb-3 wow fadeInUp" data-wow-delay=".0s">Hikvision</h3>
                                                    <h1 className="mb-3 cam-style">
                                                        Crystal Clear View, Night Vision, Smart Motion
                                                        <span></span><span></span><span></span><span></span></h1>
                                                    <Link className="btn-main btn-line fx-slide mb10 mb-3" href="contact.html"><span>Learn More</span></Link>&nbsp;&nbsp;
